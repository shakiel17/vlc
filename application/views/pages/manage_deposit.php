          ...
          <div class="card">          
            ...
            <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item addDeposit" href="#" data-bs-toggle="modal" data-bs-target="#managedeposit">Add Deposit</a></li>                                        
                  </ul>
                </div>
              <h5 class="card-title">List of Deposits
                    ...
                    if(count($expenses)>0){
                        ...
                        foreach($expenses as $branch){
                            echo "<tr>";
                                ...
                                echo "<td><a href='#' class='btn btn-sm btn-warning editDeposit' data-bs-toggle='modal' data-bs-target='#managedeposit' data-id='$branch[id]_$branch[description]_$branch[branch]_$branch[datearray]_$branch[amount]'>Edit</a>";
                                ?>
                                <a href="<?=base_url();?>delete_deposit/<?=$branch['id'];?>/<?=$branch['description'];?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this record?');return false;">Delete</a>
                                <?php
                                echo "</td>";                                
                            echo "</tr>";
                            $x++;

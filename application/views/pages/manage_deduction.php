          ...
          <div class="card">          
            ...
            <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item addDeduction" href="#" data-bs-toggle="modal" data-bs-target="#managededuction" data-id="<?=$payroll_period;?>_<?=$empid;?>">Add Deduction</a></li>                    
                  </ul>
                </div>
                    ...
                    if(count($deductions)>0){
                        ...
                        foreach($deductions as $branch){
                            echo "<tr>";
                                ...
                                echo "<td><a href='#' class='btn btn-sm btn-warning editDeduction' data-bs-toggle='modal' data-bs-target='#managededuction' data-id='$branch[id]_$branch[description]_$branch[amount]_$branch[empid]_$payroll_period'>Edit</a>";
                                ?>
                                <a href="<?=base_url();?>delete_deduction/<?=$branch['id'];?>/<?=$branch['description'];?>/<?=$payroll_period;?>/<?=$empid;?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this record?');return false;">Delete</a>
                                <?php
                                echo "</td>";                                
                            echo "</tr>";
                            $x++;

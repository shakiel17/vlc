                    ...
                    if(count($branches)>0){
                        ...
                        foreach($branches as $branch){
                            echo "<tr>";
                                ...
                                echo "<td><a href='#' class='btn btn-sm btn-warning editBranch' data-bs-toggle='modal' data-bs-target='#managedesignation' data-id='$branch[id]_$branch[designation]'>Edit</a>";
                                ?>
